...
- This is because :
    - they can be passed as arguments to other functions. (Callback)
    - they can be returned by other functions. (Closures)
    - they can be assigned as value to a variable. (Func. Expression)
...
// FUNCTION EXPRESSION
// A function expression is assigning the function to a variable. 
