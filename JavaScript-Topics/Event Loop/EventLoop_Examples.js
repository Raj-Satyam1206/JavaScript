...
Q2. If timer of 5000ms ends before the end of program and the setTimeout() is ready to execute, will JS print 
Start -> CB Timeout -> End?
...
A2. The GEC stays in the call stack until the end of the program and until then the asynchronous task need to wait. So , even if the timer of 5000ms ends, it will wait until GEC is popped from call stack. JS will execute in a synchronous manner until the end.
