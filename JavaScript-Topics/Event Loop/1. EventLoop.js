...
- What is Event Loop? 
    - Event loop is a PROGRAM in JS,  used to manage the order of execution of asynchronous tasks.
...
WEB API is a SET OF APIs THROUGH WHICH WE CAN ACCESS BROWSER FEATURES.(console , fetch() , setTimeout())
JS Engine calls the console Web API so that it can access console feature of the browser.
console.log()
