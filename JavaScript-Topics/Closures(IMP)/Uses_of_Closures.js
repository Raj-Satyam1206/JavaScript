...
// In this , 'count' can be accessible from anywere.
// But if we put an outer function, then the inner function will form a closure with the 'count' variable and cannot be accessed from anywhere.
...
//To make it more Scalable, if decrement Counter was also included , We would use CONSTRUCTOR FUNCTIONS
