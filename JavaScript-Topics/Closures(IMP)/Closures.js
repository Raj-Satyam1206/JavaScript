...
/* With CLOSURE, comes REFERENCE
Remembers the reference of variables in CLOSURES */
...
- This is because y() is forming a closure and it has access to the variables in its lexical scope.(outer scope of x())
...
It remembers the reference of 'a', and when z() invokes, 100 is present in the memory space of variable'a'. So, it prints 100.
*/


//OUTPUT will be same if 'a' was declared using 'let'
