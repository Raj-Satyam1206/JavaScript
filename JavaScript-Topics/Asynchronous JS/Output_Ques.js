...
async function getData(){
    // p.then((res) => console.log(res));
    // JS Engine does not wait for 10s for promise to be resolved
    const val = await pr;
...
-   'await' keyword stops the execution of the function(not the complete program) until the Promise is settled
