...
// Suppose we are creating an E-Commerce app and we have a cart and access to some backend APIs. First we create an order and then proceed to payment side.
...
/* 
    ...
    It is the responsibility of 'createOrder' API to create an order and callback the function for payments.

    It is the responsibility of 'proceedtoPayments' API to complete payment work and then callback the function to show the summary.
