...
- That is when all the promises returned by the API calls are settled, then promise.allSettled() will return a promise.
...
Promise.all([p1,p2,p3]) // either all resolves or error immediately 
